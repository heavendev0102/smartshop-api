...
class ProductSection(Base):
    ...
    __table_args__ = (UniqueConstraint("product_id", "section_id", name="uq_product_section"),)
    ...
    product = relationship("Product", back_populates="product_sections")
    section = relationship("Section", back_populates="product_sections")
